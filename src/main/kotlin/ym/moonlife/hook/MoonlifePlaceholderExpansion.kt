...
class MoonlifePlaceholderExpansion(
    ...
    override fun onRequest(player: OfflinePlayer?, params: String): String {
        ...
        return when (params.lowercase(Locale.ROOT)) {
            ...
            "material_drops", "active_material_drops" -> onlinePlayer?.let { featureService.activeMaterialDrops(it).joinToString("、") { rule -> rule.displayName } }.orEmpty()
            "material_drop_count", "active_material_drop_count" -> onlinePlayer?.let { featureService.activeMaterialDrops(it).size.toString() }.orEmpty()
